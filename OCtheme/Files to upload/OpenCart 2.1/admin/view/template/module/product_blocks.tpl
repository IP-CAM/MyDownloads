							...
							<table class="form">
							  ...
							  <tr class="enquiry<?php echo $module_row; ?>" <?php if($module['type'] != 2) { ?>style="display: none"<?php } ?>>
							       ...
							       <td style="padding-top: 13px"><div class="list-language">
							            ...
							            <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="product_blocks_module[<?php echo $module_row; ?>][block_name][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['block_name'][$language['language_id']]) ? $module['block_name'][$language['language_id']] : ''; ?>"></div>
							            <?php } ?>
							       </div></td>
							  </tr>
							  <tr class="enquiry<?php echo $module_row; ?>" <?php if($module['type'] != 2) { ?>style="display: none"<?php } ?>>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		<?php foreach ($languages as $language) { ?>
		html += '               <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="product_blocks_module['+ module_row +'][block_name][<?php echo $language['language_id']; ?>]" value=""></div>';
	     <?php } ?>
		html += '      </div></td>';
		html += '    </tr>';
		html += '    <tr class="enquiry' + module_row + '" style="display: none">';
