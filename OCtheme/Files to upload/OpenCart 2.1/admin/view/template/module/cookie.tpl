							...
							<table class="form">
							  ...
							  <tr>
							       ...
							       <td><div class="list-language">
							            <?php foreach ($languages as $language) { ?>
							            <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="cookie_module[<?php echo $module_row; ?>][text_dont_show_again][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['text_dont_show_again'][$language['language_id']]) ? $module['text_dont_show_again'][$language['language_id']] : ''; ?>"></div>
							            <?php } ?>
							       </div></td>
							  </tr>
                                <tr>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '      <td><div class="list-language">';
		<?php foreach ($languages as $language) { ?>
		html += '               <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="cookie_module['+ module_row +'][text_dont_show_again][<?php echo $language['language_id']; ?>]" value=""></div>';
		<?php } ?>
		html += '      </div></td>';
		html += '    </tr>';
        html += '    <tr>';
