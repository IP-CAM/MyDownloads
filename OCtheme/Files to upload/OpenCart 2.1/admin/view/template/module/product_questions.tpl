							...
							<table class="form">
							  ...
							  <tr class="enquiry<?php echo $module_row; ?>">
							       ...
							       <td style="padding-top: 13px"><div class="list-language">
							            ...
							            <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="product_questions_module[<?php echo $module_row; ?>][button_text][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['button_text'][$language['language_id']]) ? $module['button_text'][$language['language_id']] : ''; ?>"></div>
							            <?php } ?>
							       </div></td>
							  </tr>
                              <tr class="enquiry<?php echo $module_row; ?>">
							  ...
							  <tr class="enquiry<?php echo $module_row; ?>">
							       ...
							       <td style="padding-top: 13px"><div class="list-language">
							            <?php foreach ($languages as $language) { ?>
							            <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="product_questions_module[<?php echo $module_row; ?>][block_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['block_title'][$language['language_id']]) ? $module['block_title'][$language['language_id']] : ''; ?>"></div>
							            <?php } ?>
							       </div></td>
							  </tr>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		<?php foreach ($languages as $language) { ?>
		html += '               <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="product_questions_module['+ module_row +'][button_text][<?php echo $language['language_id']; ?>]" value=""></div>';
	     <?php } ?>
		html += '      </div></td>';
		html += '    </tr>';
		html += '    <tr class="enquiry' + module_row + '">';
		...
		html += '      <td style="padding-top: 13px"><div class="list-language">';
		<?php foreach ($languages as $language) { ?>
		html += '               <div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="product_questions_module['+ module_row +'][block_title][<?php echo $language['language_id']; ?>]" value=""></div>';
	     <?php } ?>
		html += '      </div></td>';
		html += '    </tr>';
		html += '   </table>';
