						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
							<table class="form" style="margin-bottom:10px">
							  <tr>
							    ...
							    <td style="border:none;padding-top:7px"><select name="custom_module2_module[<?php echo $module_row; ?>][type]" class="select-type" id="<?php echo $module_row; ?>">
							...
							<div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
							  <div class="block<?php echo $module_row; ?>" <?php if (2 == $module['type']) { echo 'style="display:none"'; } ?>>
								  <table class="form">
								    <tr>
								      <td>Block heading:</td>
								      <td><input type="text" value="<?php echo isset($module['block_heading'][$language['language_id']]) ? $module['block_heading'][$language['language_id']] : ''; ?>" name="custom_module2_module[<?php echo $module_row; ?>][block_heading][<?php echo $language['language_id']; ?>]" style="width:250px"></td>
								    </tr>
								    <tr>
								      <td>Block content:</td>
								      <td><textarea name="custom_module2_module[<?php echo $module_row; ?>][block_content][<?php echo $language['language_id']; ?>]" id="block-content-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['block_content'][$language['language_id']]) ? $module['block_content'][$language['language_id']] : ''; ?></textarea></td>
								    </tr>
								  </table>	
							  </div>
							  <div class="html<?php echo $module_row; ?>" <?php if (2 != $module['type']) { echo 'style="display:none"'; } ?>>
								  <table class="form">
								    <tr>
								      <td>HTML:</td>
								      <td><textarea name="custom_module2_module[<?php echo $module_row; ?>][html][<?php echo $language['language_id']; ?>]" class="html"><?php echo isset($module['html'][$language['language_id']]) ? $module['html'][$language['language_id']] : ''; ?></textarea></td>
								    </tr>
								  </table>
							  </div>
							</div>
							...
							<table class="form">
							  <tr>
							    <td>Layout:</td>
							    <td><select name="custom_module2_module[<?php echo $module_row; ?>][layout_id]">
							  ...
							  <tr>
							    <td>Position:</td>
							    <td><select name="custom_module2_module[<?php echo $module_row; ?>][position]">
							  ...
							  <tr>
							    <td>Status:</td>
							    <td><select name="custom_module2_module[<?php echo $module_row; ?>][status]">
							  ...
							  <tr>
							    <td>Sort Order:</td>
							    <td><input type="text" name="custom_module2_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
							  </tr>
							</table>
						</div>
						<?php $module_row++; ?>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '				<select name="custom_module2_module[' + module_row + '][type]" class="select-type" id="' + module_row + '">';
		...
		html += '				<td><input type="text" value="" name="custom_module2_module[' + module_row + '][block_heading][<?php echo $language['language_id']; ?>]" style="width:250px"></td>';
		html += '			</tr>';
		html += '			<tr>';
		html += '				<td>Block content:</td>';
		html += '				<td><textarea name="custom_module2_module[' + module_row + '][block_content][<?php echo $language['language_id']; ?>]" id="block-content-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
		html += '			</tr>';
		html += '	   </table>';
		html += '	 </div>';
		...
		html += '        <tr>';
		html += '          <td>HTML:</td>';
		html += '          <td><textarea name="custom_module2_module[' + module_row + '][html][<?php echo $language['language_id']; ?>]" class="html"></textarea></td>';
		html += '        </tr>';
		html += '      </table>';
		html += '	  </div>';
		...
		html += '    <tr>';
		html += '      <td>Layout:</td>';
		html += '      <td><select name="custom_module2_module[' + module_row + '][layout_id]">';
		...
		html += '    <tr>';
		html += '      <td>Position:</td>';
		html += '      <td><select name="custom_module2_module[' + module_row + '][position]">';
		...
		html += '    <tr>';
		html += '      <td>Status:</td>';
		html += '      <td><select name="custom_module2_module[' + module_row + '][status]">';
		...
		html += '      <td><input type="text" name="custom_module2_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
		html += '    </tr>';
		html += '  </table>'; 
	html += '</div>';
