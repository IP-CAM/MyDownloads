  ...
  ?>
  <div class=" blog-module box-no-advanced" style="padding-top: 20px;padding-bottom: 10px">
  	  <h2 class="slider-title"><span class="inline-title"><?php echo $text_related_articles; ?></span><span class="line"></span></h2>
