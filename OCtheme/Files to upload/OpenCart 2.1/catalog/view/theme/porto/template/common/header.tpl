...
<head>
	...
	<?php $lista_plikow = array(
			...
			'catalog/view/theme/'.$config->get( 'config_template' ).'/css/font-icons.css'
	); 
    ...
    $lista_plikow[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/js/isotope.pkgd.min.js';
...
<body class="<?php if($theme_options->get( 'layout_type' ) == 3) { echo 'body-full-width';  } ?> <?php echo $class; ?> <?php echo $theme_options->get( 'body_custom_class' ); ?> skin1 <?php if($theme_options->get( 'header_type' ) > 1) {  echo 'body-header-type-' . $theme_options->get( 'header_type' ); } else { echo 'body-header-type-1'; } ?>">
